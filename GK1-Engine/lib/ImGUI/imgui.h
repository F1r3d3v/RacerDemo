...
#ifndef IMGUI_API_CALL
#if defined(IMGUI_API_CALL_EXPORT)
#if  defined(_WIN32) || defined(__CYGWIN__)
#if defined(IMGUI_API_CALL_EXPORT_BUILD)
#if defined(__GNUC__)
#define IMGUI_API_CALL __attribute__ ((dllexport))
#else
#define IMGUI_API_CALL __declspec(dllexport)
#endif
#else
#if defined(__GNUC__)
#define IMGUI_API_CALL __attribute__ ((dllimport))
#else
#define IMGUI_API_CALL __declspec(dllimport)
#endif
#endif
#elif defined(__GNUC__) && defined(IMGUI_API_CALL_EXPORT_BUILD)
#define IMGUI_API_CALL __attribute__ ((visibility ("default")))
#else
#define IMGUI_API_CALL
#endif
#else
#define IMGUI_API_CALL
#endif
...
#ifndef IMGUI_API
#define IMGUI_API			   IMGUI_API_CALL
#endif
